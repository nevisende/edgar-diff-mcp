...
export function htmlToLines(html: string): string[] {
  ...
  const lines = raw
    .replace(/[\u200B\uFEFF\u00AD]/g, '') // zero-width space / BOM / soft hyphen, anywhere in EDGAR HTML
    .replace(/\u00A0/g, ' ')
    .split('\n')
...
/** At least this many headings within TOC_MAX_GAP lines of each other form a table of contents. */
const TOC_MIN_RUN = 3;
const TOC_MAX_GAP = 2;
...
/**
 * Classify headings. A run of at least TOC_MIN_RUN headings within TOC_MAX_GAP lines of

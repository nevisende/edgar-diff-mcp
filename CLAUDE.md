...
## Commands
- `npm run check`: ASCII lint + typecheck + tests. Must pass before you stop.
...
- Zod schemas describe every tool input; the description text is what the agent reads, so write it for the agent.
